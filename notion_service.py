...
def _build_notion_client() -> tuple[Client, str, str]:
    """Load Notion settings and return a ready client plus parent/tag IDs."""
    load_dotenv()
    ...
    return Client(auth=token), data_source_id, tag_page_id
...
def test_notion_connection() -> str:
    ...
    """
    client, data_source_id, tag_page_id = _build_notion_client()
